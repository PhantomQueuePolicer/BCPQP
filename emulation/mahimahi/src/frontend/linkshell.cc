...
unique_ptr<AbstractPacketQueue> get_packet_queue( const string & type, const string & args, const string & program_name )
{
    if ( type == "infinite" ) {
        ...
        return unique_ptr<AbstractPacketQueue>( new Shaper( args ) );
    } else if ( type == "pqp" ) {
        return unique_ptr<AbstractPacketQueue>( new PQP( args ) );
    } else if ( type == "bcp" ) {
        return unique_ptr<AbstractPacketQueue>( new BCPQP( args ) );
    } else if ( type == "fpl" ) {
        return unique_ptr<AbstractPacketQueue>( new FairPolicer( args ) );
    } else if ( type == "plc" ) {
        return unique_ptr<AbstractPacketQueue>( new Policer( args ) );
    } else {
